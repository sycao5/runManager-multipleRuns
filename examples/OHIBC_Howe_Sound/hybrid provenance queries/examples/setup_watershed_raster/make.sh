...
# draw prospective provenance graph upstream of rast_watershed
productName="rast_watershed"
...
# list script inputs upstream of output data rast_watershed
productName="rast_watershed"
...
# draw prospective provenance graph downstream of howe_sound_watersheds
productName="howe_sound_watersheds"
...
# list script outputs downstream of input data howe_sound_watersheds
productName="howe_sound_watersheds"
...
# draw hybrid provenance graph upstream of rast_watershed
productName="rast_watershed"
