...
# @BEGIN Write_year_by_year_status_&_trend_estimates
...
# @BEGIN create_new_stats_&_trend_file 
# @param dir_goal
...
# @END create_new_stats_&_trend_file
...
# @BEGIN save_year_by_year_status_&_trend_estimates
# @in status_df_data
# @in trend_df_data
# @out lsp_status_trend_summary_db_file @URI dbfile://
...
# @END save_year_by_year_status_&_trend_estimates


#DT::datatable(lsp_status_trend_summary, caption = 'LSP status and trend estimates')

# @END Write_year_by_year_status_&_trend_estimates