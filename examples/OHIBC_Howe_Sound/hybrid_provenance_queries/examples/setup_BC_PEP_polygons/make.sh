...
# draw prospective provenance graph upstream of poly_hs_pep
productName="poly_hs_pep"
...
# list script inputs upstream of output data poly_hs_pep
productName="poly_hs_pep"
...
# draw prospective provenance graph downstream of TA_PEP_SVW_polygon
productName="TA_PEP_SVW_polygon"
...
# list script outputs downstream of input data TA_PEP_SVW_polygon
productName="TA_PEP_SVW_polygon"
...
# draw hybrid provenance graph upstream of poly_hs_pep
productName="poly_hs_pep"
