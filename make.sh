...
dot -Tsvg $RESULTS_DIR/wf_upstream_of_test_data.gv > $RESULTS_DIR/wf_upstream_of_test_data.svg
...
dot -Tsvg $RESULTS_DIR/wf_upstream_of_test_data_2.gv > $RESULTS_DIR/wf_upstream_of_test_data_2.svg
